...
formula_full <- milex_gdp_post ~ dist_enemy_log + border_rus + nato_gap_2021 + debt_gdp_2021_log
...
# Save
ggsave(here("_output", "_figures", "ols_loo_gdp_post.png"), p_jack, width = 8, height = 8, bg = "white")
# ---------------------------------------------------------------------------- #
