  ...
  tryCatch(
    {
      ...
      plot_filename <- file.path(DIR_FIG, glue("es_base_plot_{var_name}.png"))
      ...
      table_es_gt <- gt(table_data_for_gt) %>%
        tab_header(
          title = glue("Base Event Study Model: {var_name}"),
      ...
      table_html_filename <- file.path(DIR_TAB, glue("es_base_table_{var_name}.html"))
