...
z_results <- bind_rows(
  ...
  compare_coeffs("Log BNP", "gdp_2014_log", "gdp_2021_log")
)
...
# Save
gtsave(z_table, here("_output", "_tables", "z_test_summary_gdp.html"))

message("Z-Test Table saved to _output/_tables/z_test_summary_gdp.html")
