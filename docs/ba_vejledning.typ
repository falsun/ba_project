...
position: bottom, 
[
An overview of the data sources and the raw comparison between the original treatment and control groups.
]), 
...
position: bottom, 
[
An exploration of heterogeneity within the European NATO sample, showing trends by historical, geographical, and threat-based groupings.
]), 
kind: "quarto-float-fig", 
supplement: "Figure", 
)
